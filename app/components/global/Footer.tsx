  ...
  <div className="container mx-auto px-4 py-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="lg:col-span-2">
        ...
        <p className="text-gray-300 mb-4 text-justify">
          We are a family of dedicated businesses committed to bringing quality products and services 
          to our community. Through our various brands and ventures, we strive to empower local 
      ...
      <div>
        ...
        <ul className="space-y-3">
          <li>
            <a href="https://sajilosnacks.kyte.site" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors flex items-center">
      ...
      <div>
        ...
        <ul className="space-y-3 text-gray-300">
          ...
          <li className="flex items-start">
            <svg className="w-5 h-5 mr-3 mt-0.5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
            </svg>
            sajilosnacks@gmail.com
          </li>
          <li className="flex items-start">
    ...
    <div className="border-t border-gray-700 mt-8 pt-8">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
          ...
          <p className="text-gray-300">Get news about our latest brands and products</p>
        </div>
    ...
    <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
      <div className="text-gray-400 text-sm mb-4 md:mb-0">
        © {new Date().getFullYear()} Our Business Family. All rights reserved.
      </div>
